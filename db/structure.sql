...
--
-- Name: pool_scans; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.pool_scans (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    pool_id uuid NOT NULL,
    volume_usd numeric(18,2),
    reserve_in_usd numeric(18,2),
...
CREATE TABLE public.pools (
    ...
    base_token_address character varying,
    quote_token_address character varying,
    created_at timestamp(6) without time zone NOT NULL,
    updated_at timestamp(6) without time zone NOT NULL,
    latest_scan_id uuid,
    pool_name character varying,
    base_token_symbol character varying,
    quote_token_symbol character varying
);
...
--
-- Name: pool_scans pool_scans_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pool_scans
    ADD CONSTRAINT pool_scans_pkey PRIMARY KEY (id);
...
--
-- Name: index_pool_scans_on_pool_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_pool_scans_on_pool_id ON public.pool_scans USING btree (pool_id);


--
-- Name: index_pool_scans_on_scanned_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_pool_scans_on_scanned_at ON public.pool_scans USING btree (scanned_at);


--
-- Name: index_pools_on_base_token_symbol; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_pools_on_base_token_symbol ON public.pools USING btree (base_token_symbol);


--
-- Name: index_pools_on_network_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_pools_on_network_id ON public.pools USING btree (network_id);


--
-- Name: index_pools_on_pool_address; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_pools_on_pool_address ON public.pools USING btree (pool_address);


--
-- Name: index_pools_on_quote_token_symbol; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_pools_on_quote_token_symbol ON public.pools USING btree (quote_token_symbol);
...
--
-- Name: pool_scans fk_rails_2438872ab7; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pool_scans
    ADD CONSTRAINT fk_rails_2438872ab7 FOREIGN KEY (pool_id) REFERENCES public.pools(id);
